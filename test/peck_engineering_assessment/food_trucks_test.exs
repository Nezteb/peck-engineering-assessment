defmodule PeckEngineeringAssessment.FoodTrucksTest do
  ...
  describe "food_trucks" do
    ...
    test "get_food_truck!/1 returns the food_truck with given location_id" do
      food_truck = food_truck_fixture()
      assert FoodTrucks.get_food_truck!(food_truck.location_id) == food_truck
    end
    ...
    test "update_food_truck/2 with invalid data returns error changeset" do
      ...
      assert food_truck == FoodTrucks.get_food_truck!(food_truck.location_id)
    end
    ...
    test "delete_food_truck/1 deletes the food_truck" do
      ...
      assert_raise Ecto.NoResultsError, fn ->
        FoodTrucks.get_food_truck!(food_truck.location_id)
      end
    end
