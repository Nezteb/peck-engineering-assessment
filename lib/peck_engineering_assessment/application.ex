defmodule PeckEngineeringAssessment.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: PeckEngineeringAssessment.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    PeckEngineeringAssessmentWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
